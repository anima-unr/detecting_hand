...
obj_cup1 = []
obj_cup2 = []
cup_fix_loc_1 = location()

ban_fix_loc_1 = location()

clock_fix_loc_1 = location()
...
def get_obj_loc_client():  # service call to find the cup location from YOLO
    ...
    try:
        ...
        global cup_loc_save, bowl_loc_save, clock_loc_save, hand_loc, hand_count,object
        ...
        if msg.Class == "scissors" and cup_check == 1:
            cup_loc_save = msg
            object_loc[0].center_x_1 = msg.xmin
            object_loc[0].center_y_1 = msg.ymin + (msg.ymaxx - msg.ymin) / 2;
            object_loc[0].center_x_2 = msg.xmax
            object_loc[0].center_y_2 = msg.ymin + (msg.ymaxx - msg.ymin) / 2;

            val_1 = 1
            if fix_cup_flag == 0:
                cup_fix_loc_1 = object_loc[0]

                fix_cup_flag = 1
            if fix_cup_flag == 2:
                if cup_fix_loc_1.center_x_1 - 10 <= object_loc[0].center_x_1 <= cup_fix_loc_1.center_x_1 + 10 or cup_fix_loc_1.center_y_1 - 10 <= object_loc[0].center_y_1 <= cup_fix_loc_1.center_y_1 + 10:
        ...
        if msg.Class == "bowl" and ban_check == 1:
            bowl_loc_save = msg
            object_loc[1].center_x_1 = msg.xmin;
            object_loc[1].center_y_1 = msg.ymin + (msg.ymaxx - msg.ymin) / 2;
            object_loc[1].center_x_2 = msg.xmax;
            object_loc[1].center_y_2 = msg.ymin + (msg.ymaxx - msg.ymin) / 2;
            val_2 = 1
            if fix_ban_flag == 0:
                ban_fix_loc_1 = object_loc[1]

                fix_ban_flag = 1
            if fix_ban_flag == 2:
                if ban_fix_loc_1.center_x_1 - 10 <= object_loc[1].center_x_1 <= ban_fix_loc_1.center_x_1 + 10 or ban_fix_loc_1.center_y_1 - 10 <= object_loc[1].center_y_1 <= ban_fix_loc_1.center_y_1 + 10:
        ...
        if msg.Class == "clock" and clock_check == 1:
            clock_loc_save = msg
            object_loc[2].center_x_1 = msg.xmin;
            object_loc[2].center_y_1 = msg.ymin + (msg.ymaxx - msg.ymin) / 2;
            object_loc[2].center_x_2 = msg.xmax;
            object_loc[2].center_y_2 = msg.ymin + (msg.ymaxx - msg.ymin) / 2;
            val_3 = 1
            if fix_clock_flag == 0:
                clock_fix_loc_1 = object_loc[2]

                fix_clock_flag = 1
            if fix_clock_flag == 2:
                if clock_fix_loc_1.center_x_1 - 10 <= object_loc[2].center_x_1 <= clock_fix_loc_1.center_x_1 + 10 or clock_fix_loc_1.center_y_1 - 10 <= object_loc[2].center_y_1 <= clock_fix_loc_1.center_y_1 + 10:
...
def callback(r_val):
    ...
    if r_val != 0:
        ...
        print
        "cup center: %.2f %.2f " % (object_loc[0].center_x_2, object_loc[0].center_y_2)
        print
        "bowl center:%.2f %.2f " % (object_loc[1].center_x_1, object_loc[1].center_y_1)
        print
        "bowl center: %.2f %.2f " % (object_loc[1].center_x_2, object_loc[1].center_y_2)
        ...
        if count % 2 == 0:  # average the hand values after 10 rounds
            ...
            calculating_vectors(object_loc[0].center_x_2, object_loc[0].center_y_2, cobject_loc[0].center_x_1, object_loc[0].center_y_1, hand_x_avg, hand_y_avg)
            ...
            calculating_vectors(object_loc[1].center_x_2, object_loc[1].center_y_2, cobject_loc[1].center_x_1, object_loc[1].center_y_1, hand_x_avg, hand_y_avg)
            ...
            calculating_vectors(object_loc[2].center_x_2, object_loc[2].center_y_2, cobject_loc[2].center_x_1, object_loc[2].center_y_1, hand_x_avg, hand_y_avg)
