...
def get_obj_loc_client():  # service call to find the cup location from YOLO
    ...
    try:
        ...
        global cup_loc_save, bowl_loc_save, clock_loc_save, hand_loc, hand_count, object_loc, obj_name
        ...
        object_loc = []
        if hand.center_x != 609 and hand.center_y != 187:
            for x in range(0, 3):
                ...
                if obj_check[x] == 1:
                    ...
                    if msg.Class == obj_name[x]:
                        ...
                        object_temp = calculating_midpoint(msg)
...
def callback(r_val):
    ...
    if hand.center_x != 372 and hand.center_y != 433:
